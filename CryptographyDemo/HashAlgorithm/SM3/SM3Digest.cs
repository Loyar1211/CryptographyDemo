...
{
    /// <summary>
    /// 此类根据SM2的依赖所创建，该非对称加密的文件中并没有使用本类库进行数据转换
    /// 但是同样可以应用于SM3加密中
    /// </summary>
    public abstract class GeneralDigest : IDigest
    {
        ...
        internal GeneralDigest(GeneralDigest t)
        {
            ...
            Buffer.BlockCopy(t.xBuf, 0, xBuf, 0, t.xBuf.Length);
    ...
    public class SM3Digest : GeneralDigest
    {
        ...
        public SM3Digest(SM3Digest t) : base(t)
        {
            ...
            Buffer.BlockCopy(t.X, 0, X, 0, t.X.Length);
            xOff = t.xOff;
            Buffer.BlockCopy(t.v, 0, v, 0, t.v.Length);
        }
        ...
        public override void Reset()
        {
            ...
            Buffer.BlockCopy(v0, 0, v, 0, v0.Length);

            xOff = 0;

            Buffer.BlockCopy(X0, 0, X, 0, X0.Length);
        }
        ...
        internal override void ProcessBlock()
        {
            ...
            Buffer.BlockCopy(vv, 0, vv_, 0, v0.Length);
